...
class Database extends Config
{
    ...
    public function __construct()
    {
        ...
        // Vercel / Serverless Environment Helper (Dots are not allowed in Env Keys)
        // Map database_default_hostname -> $default['hostname']
        if ($host = getenv('database_default_hostname')) {
            $this->default['hostname'] = $host;
        }
        if ($db = getenv('database_default_database')) {
            $this->default['database'] = $db;
        }
        if ($user = getenv('database_default_username')) {
            $this->default['username'] = $user;
        }
        if ($pass = getenv('database_default_password')) {
