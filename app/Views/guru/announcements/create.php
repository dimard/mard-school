...
<head>
    <?= view('layouts/head_meta', [
        ...
        'metaDescription' => 'Buat Pengumuman Baru'
    ]) ?>
                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Pengumuman Baru untuk <?= esc($class['name']) ?></h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('guru/classes/announcements/' . $class['id'] . '/store') ?>" method="POST">
                                <?= csrf_field() ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              rows="8"
                                              required
                                              placeholder="Tulis pengumuman Anda di sini..."><?= old('content') ?></textarea>
                                    <small class="text-muted">Minimal 10 karakter</small>
                                </div>

                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ph ph-paper-plane-right me-2"></i>Posting Pengumuman
                                    </button>
