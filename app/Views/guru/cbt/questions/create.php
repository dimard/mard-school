...
<head>
    <?= view('layouts/head_meta', ['pageTitle' => 'Tambah Soal']) ?>
                ...
                <div class="col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Tambah Soal untuk: <?= esc($exam['exam_name']) ?></h5>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('guru/cbt/' . $exam['id'] . '/questions/store') ?>"
                                method="post">
                                <?= csrf_field() ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="correct_answer" class="form-select" required>
                                        ...
                                        <option value="A" <?= old('correct_answer') == 'A' ? 'selected' : '' ?>>Opsi A
                                        </option>
                                        <option value="B" <?= old('correct_answer') == 'B' ? 'selected' : '' ?>>Opsi B
                                        </option>
                                        <option value="C" <?= old('correct_answer') == 'C' ? 'selected' : '' ?>>Opsi C
                                        </option>
                                        <option value="D" <?= old('correct_answer') == 'D' ? 'selected' : '' ?>>Opsi D
                                        </option>
                                        <option value="E" <?= old('correct_answer') == 'E' ? 'selected' : '' ?>>Opsi E
                                        </option>
                                    </select>
                                </div>
