...
<head>
    <?= view('layouts/head_meta', ['pageTitle' => 'Edit Ujian']) ?>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('guru/cbt/update/' . $exam['id']) ?>" method="post">
                                <?= csrf_field() ?>

                                <div class="mb-3">
                                    <label class="form-label">Kelas</label>
                                    <input type="text" class="form-control"
                                        value="ID Kelas: <?= esc($exam['class_id']) ?>" disabled>
                                    <input type="hidden" name="class_id" value="<?= esc($exam['class_id']) ?>">
                                    <small class="text-muted">Kelas tidak dapat diubah setelah dibuat.</small>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" name="end_time"
                                            value="<?= old('end_time', $exam['end_time']) ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="passing_score"
                                            value="<?= old('passing_score', $exam['passing_score']) ?>" min="0"
                                            max="100" required>
                                    </div>
                                </div>
