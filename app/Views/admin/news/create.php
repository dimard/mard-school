...
<head>
    <?= view('layouts/head_meta', ['pageTitle' => 'Buat Berita']) ?>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" class="form-control form-control-lg"
                                                value="<?= old('title') ?>" placeholder="Masukkan judul yang menarik..."
                                                required>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="image" class="form-control"
                                                        accept="image/*">
                                                    <small class="text-muted d-block mt-1">Rek: 800x600px, Maks
                                                        2MB</small>
                                                </div>
                                                ...
                                                <div class="d-grid gap-2">
                                                    <button type="submit" class="btn btn-primary">
                                                        <i class="ph ph-paper-plane-right me-2"></i>Terbitkan Berita
                                                    </button>
